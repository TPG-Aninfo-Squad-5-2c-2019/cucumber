...
class ChangeState{
	static String changeFromTo (String old_state, String new_state) {
		if (old_state.equals("uninitiated")){
			return new_state.equals("in_process") ? "was" : "wasn't";
		} else if (old_state.equals("in_process")) {
...
public class ChangeStateOfATask {
    ...
    public void i_try_to_change_it_from_the_old_state_to_a_new_state (String old_state,String new_state) {
