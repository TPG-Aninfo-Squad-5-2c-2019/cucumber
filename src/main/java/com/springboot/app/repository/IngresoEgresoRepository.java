...
public class IngresoEgresoRepository { 
    // static variable single_instance of type Singleton 
    private static IngresoEgresoRepository single_instance = null; 

    private List<IngresoEgreso> lista = new ArrayList<IngresoEgreso>();

    // static method to create instance of Singleton class 
    public static IngresoEgresoRepository getInstance() 
    { 
        if (single_instance == null) {
            single_instance = new IngresoEgresoRepository(); 
